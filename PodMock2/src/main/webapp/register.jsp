...
<body style="background-color: white; overflow: hidden">
		...
		<div
			...
			<div class="dropdown" style="width: 10.83vw;">
				...
				<div class="dropdown-content">
					<a href="login.jsp" style="width: 12.83vw;">Public Login</a><br>
					<a href="policelogin.jsp" style="width: 12.83vw;">Police Login</a>
				</div>
			</div>
	...
	<form style="position: relative; top: 40px; left: 500px;" method="post"
		action="RegistrationController">
		
		<table>
		
			<tr><td style="color:red; font-size:18px;" colspan="2"><center><div>${Registration} ${mail}</div></center> </td></tr>
		
			<tr>
				<td><label for="username">Enter Full Name:<span
			...
			<tr>
				<td><label for="password">Enter Password:<span
						class="required">*</span></label></td>
			...
			<tr>
				<td><label for="age">Enter Age:<span class="required">*</span></label></td>
				<td><input type="text" name="age" placeholder="Enter Age"
					required></td>
					
			</tr>
			<tr>
				<td><label for="Id Card Number">Enter Id Number:<span
						class="required">*</span></label></td>
			...
			<tr>
				<td><label for="Mobile NO">Enter Mobile No:<span
						class="required">*</span></label></td>
				<td><input type="text" name="mobilenumber"
					placeholder="Enter Mobile Number" required></td>
				<td><input type="submit" id="sendotp" value="Send OTP" id="generate otp"></td>
			</tr>
			<tr>
				<td><label for="OTP">OTP<span class="required">*</span></label></td>
				<td><input type="text" name="otp" placeholder="Enter OTP"></td>
				
			</tr>
			
			<td align="center" colspan="2"><button type="submit" id="verify">Register</button></td>
