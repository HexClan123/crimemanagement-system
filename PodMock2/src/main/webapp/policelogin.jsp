...
<body style="overflow: hidden; background-color: white;">
	...
	<!----------------Ploice Login Page Containt Start------------------>

	<h1>Welcome to Police Login Page!</h1>
	<br>
	<form>
		<table align="center">
			<tr>
				<td><label for="username" style="font-size: medium;">Enter
						the Id:<span class="required">*</span>
				</label></td>
				<td><input type="id" name="userId" placeholder="Enter Login Id"
					required></td>
			</tr>
			<tr>
				<td><label for="password" style="font-size: medium;">Enter
						the Password:<span class="required">*</span>
				</label></td>
				<td><input type="password" name="password"
					placeholder="Enter Password" required></td>
			</tr>
			<tr>
				<td align="center" colspan="2"><button class="g-recaptcha"
						data-sitekey="reCAPTCHA_site_key" data-callback='onSubmit'
						data-action='submit'>Verify</button></td>
			</tr>
		</table>
	</form>
